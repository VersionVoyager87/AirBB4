    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 2m, 2, 2000, 4, 1, "Chicago Loop Apartment", 1, 180m, "chi1.jpg" },
                    { 2, 2, 1m, 1, 2005, 2, 1, "River North Condo", 1, 140m, "chi2.jpg" },
                    { 3, 3, 1m, 1, 2010, 3, 2, "Midtown Loft", 2, 220m, "ny1.jpg" },
                    { 4, 4, 1m, 2, 1995, 4, 2, "Brooklyn Brownstone", 2, 200m, "ny2.jpg" },
                    { 5, 6, 2m, 3, 2012, 6, 3, "Miami Beach House", 3, 260m, "miami1.jpg" },
                    { 6, 2, 1m, 1, 2015, 2, 3, "South Beach Condo", 3, 180m, "miami2.jpg" },
                    { 7, 5, 2m, 3, 2003, 5, 4, "Suburban Family Home", 4, 190m, "atlanta1.jpg" },
                    { 8, 3, 1m, 2, 2008, 3, 4, "Downtown Apartment", 4, 160m, "atlanta2.jpg" }
                });
